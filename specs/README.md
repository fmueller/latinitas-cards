...
- `specs/v0.2.0.md` through `specs/v1.0.0.md` are planned, inactive release specs. They
  ...
  normalized corpora and agent contracts, corpus-first generation, grammar/syntax study,
  optional direct Anki integration, reproducible projects, CLI/migration hardening, release
  validation, and the v1 stable contract.
